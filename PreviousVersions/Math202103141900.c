...
//2:Create and implement the function to find a line perpendicular to another two lines and that passes by one certain point
									...
									case 3: do{//Find Line
											...
											switch(o4){
												...
												case 2: if(np<1){
													...
													break;
												case 3: if(nl<2){
														printf("ERROR: You dont have enough lines created to use this function");
													}
													else{
														printf("\nEnter the numbers related to the points you want to use to calculate the line separated by a coma.\nLINES:\n");
														n=1;
