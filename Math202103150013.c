			...
			case 1:	do{//GEOMETRY
				       	...
				       	switch(o2){
				       		case 1: do{//CREATING
								...
								switch(o3){
									...
									case 4: CreatePlane(&Planes[npl][1], &Planes[npl][2], &Planes[npl][3], &Planes[npl][4]);np++;break;
								}
							}while(o3!=0);
							break;
						case 2:	do{//SHOW WHAT HAS BEEN CREATED
								...
								switch(o3){
									...
									case 4: printf("\n\nPLANES:\n");n=1;do{ShowPlanes(n, Planes[n][1], Planes[n][2], Planes[n][3], Planes[n][4]);n++;}while(n<npl);break;
								}
							}while(o3!=0);
							break;
						case 3: do{//COMPARE
	...
	do{
		...
		*d=dlocal;
			if(yv>0){
				if(zv>0){
					if(d>0){
						printf("\nThe plane you created is %fX+%fY+%fZ+%f=0. If this is correct press 0, if its not press 1.", xn, yn, zn, dlocal);
					}
					else{printf("\nThe plane you created is %fX+%fY+%fZ%f=0. If this is correct press 0, if its not press 1.", xn, yn, zn, dlocal);}
				}
				else{
				...
				if(zv>0){
					...
					else{printf("\nThe plane you created is %fXfY+%fZ%f=0. If this is correct press 0, if its not press 1.", xn, yn, zn, dlocal);}
				}
				else{
					if(d>0){
						printf("\nThe plane you created is %fX%fY%fZ+%f=0. If this is correct press 0, if its not press 1.", xn, yn, zn, dlocal);
