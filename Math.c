...
//2:[MAYBE GOOD MAYBE BAD] Currently, the function CreatePlane();requires the user to know a point and i think the more suitable thing is to ask for the value of d. [MAYBE GOOD MAYBE BAD]
//3:Come up with more ideas for the function ShowGeometryFindPointMenu();
//4:Come up with more ideas for the function ShowGeometryFindLineMenu();
//5:Finish the function ShowGeometryFindPlaneMenu();and implement all the options.
						...
						case 3: do{//COMPARE
								...
								switch(o3){
									...
									case 5: if(np<1){//Compare Point and Line
										...
										break;
									case 6: if(np<1){//Compare Point and Plane
											printf("\nERROR:You dont have enough points created to use this function");
										}
										else if(npl<1){
										...
										break;
									case 7: if(nl<1){//Compare Line and Plane
											printf("\nERROR:You dont have enough lines created to use this function");
										}
										else if(npl<1){
											printf("\nERROR:You dont have enough planes created to use this function");
...
void ShowGeometryComparingMenu(){
	...
	printf("\nTo compare a point and a plane press 6");
	printf("\nTo compare a line and a plane press 7");
...
void CompareTwoLines(float xp1, float yp1, float zp1, float xv1, float yv1, float zv1, float xp2, float yp2, float zp2, float xv2, float yv2, float zv2){//I am going to use s as alfa1 and t as alfa2. 
	...
	if((xv1/xv2==yv1/yv2)&&(yv1/yv2==zv1/zv2)){//The vectors are parallel to each other. This means the lines can either be parallel or the same line with different equations.
		...
		if(det==0){//They intersect
			...
			printf("\nThe two lines cross each other but dont intersect and they are separated at a distance of [NOT YET PROGRAMMED]");
		}
	}
}
